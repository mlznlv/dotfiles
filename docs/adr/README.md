...
| [0010](0010-define-selection-aware-shell-rendering.md) | Proposed | Define selection-aware shell rendering |
...
ADR 0010 proposes an ephemeral render context, exact shell-target ownership,
and selection-aware activation. It is not binding until owner acceptance.
