...
Catalogs below tests/fixtures exist only to test behavior. They are not product
modules or curated profiles and must never appear in the production catalog.
